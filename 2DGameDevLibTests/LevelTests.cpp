...
public:
	...
	void SetUp() override
	{
		...
		RoomPtr = std::make_shared<Room>("MyRoom", "Room", 0, 0, 0, 100, 100);
	}
	...
	std::shared_ptr<Room> RoomPtr = nullptr;
...
TEST_F(LevelTesting, Test_AddGameObjectToScene)
{
	...
	const auto enemy = CharacterBuilder::BuildEnemy("MyEnemy01", RoomPtr, 18, gamelib::Direction::Down, TheLevel);
