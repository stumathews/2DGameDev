...
public:	
	...
	void ConfigureRooms(std::vector<std::shared_ptr<Room>>& rooms) const;
	void ConfigureWalls(const std::shared_ptr<Room>& thisRoom, const bool& canRemoveWallAbove, const std::vector<std::shared_ptr<Room>>& rooms, const std::shared_ptr<Room>& nextRoom, const bool& canRemoveWallRight, const bool& canRemoveWallBelow, const bool& canRemoveWallLeft, const int& prevIndex) const;
